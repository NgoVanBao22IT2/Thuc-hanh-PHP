...
// Hàm cập nhật thông tin đánh giá. Khi người dùng check vào ô đánh giá điểm, thì chúng 
// ta sẽ cập nhật số người đánh giá điểm số đó thêm 1 người như sau
...
// Hàm lấy sản phẩm. Hàm này dùng để lấy thông tin của 1 sản phẩm thông qua ID và trả
// lại kết quả HTML.
...
// Hàm lấy danh sách sản phẩm. Hàm này dùng để lấy tất cả các sản phẩm trong CSLD và 
// trả về kết quả HTML
